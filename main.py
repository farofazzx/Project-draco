...
APP_IMAGE_URL = "https://www.defcon-lab.org/wp-content/uploads/2022/10/hacktivismo-880x400.jpg"
...
class AttackThread(QThread):
    ...
    def run(self):
        ...
        """
        self.log_signal.emit(" Mafia Team Panel ACTIVATED! TARGET LOCKED! \n")
        if self.use_proxy:
        ...
        if self.running:
            self.log_signal.emit("\n Mafia Team Panel FINISHED. TARGET ELIMINATED. ")
    ...
    def stop(self):
        ...
        """
        self.running = False
        self.log_signal.emit("\n Mafia Team Panel HALTED BY USER.")
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Il n'est pas nécessaire de donner toutes les réponses.")
        ...
        self.credit_label = QLabel("by Lost3r")
        ...
        self.start_button = QPushButton("LAUNCH Mafia Panel")
    ...
    def load_image_from_url(self, url):
        ...
        try:
            ...
            if not pixmap.isNull():
                ...
                self.log_message(" IMAGE LOADED! Mafia Team Panel IS READY!")
            else:
